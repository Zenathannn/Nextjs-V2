...
export default function WebPConversion({ compressedFile, resizeData }: WebPConversionProps) {
    ...
    const formatBytes = (bytes: number) => {
        return (bytes / 1024).toFixed(2) + 'KB'; // fix: 104 → 1024
    };

    return (
        <div className="bg-white rounded-lg shadow-lg p-6">
            <h2 className="text-2xl font-bold mb-4">WebP Conversion</h2>
            <p className="text-gray-600 mb-6">Convert ke format WebP untuk performa optimal</p> {/* fix: nb-6 → mb-6 */}
