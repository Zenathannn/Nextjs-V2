    ...
    try {
        ...
        await sharp(buffer)
           ...
           return  NextResponse.json ({
            ...
            // provide both `size` and `sizes` so the client code can
            // continue using the existing property names without changing
            // too much. `size.compressed` and `sizes.thumbnail` are used
            // in the component.
            size: {
